...
## Overview
Startpage is a customizable dashboard-style browser start page. Search, weather, tasks, notes, news, system status, and the integrated Startpage Agent run fully in the browser (localStorage). Version: **v1.10.1**. Live: https://julianverse.de/startpage/
